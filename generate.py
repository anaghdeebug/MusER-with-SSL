...
if __name__=='__main__':
    ...
    parser.add_argument("--VQ_prior", type=str, default='Prior_MusER_TRANS_CA_GE_emopia')
    ...
    VQ_dict_file = open('data/MusER_TRANS_CA_GE_emopia_VQ_dict.data', 'rb')
    VQ_dict = pickle.load(VQ_dict_file)
    # print(VQ_dict[0])
    # print(VQ_dict[1])
    ####################
    VQ_VAE_path=f'./saved_models/{args.VQ_VAE}/0_best.pth'
    ...
    VQ_VAE_model.eval()
    #####################
    VQ_prior_path=f'./saved_models/{args.VQ_prior}/0_best.pth'
